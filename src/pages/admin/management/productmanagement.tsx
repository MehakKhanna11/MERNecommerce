...
const Productmanagement = () => {
  ...
  const {price,photo,name,category,stock}=data?.product|| {photo:"",category:"",name:"",stock:0,price:0};
  ...
  const deleteHandler = async(e: FormEvent<HTMLButtonElement>): Promise<void>=> {
    e.preventDefault();
